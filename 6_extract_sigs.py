...
if __name__ == '__main__':
	...
	if Config.args.cluster:
		freeze_support()
		sig.sigProfilerExtractor("matrix", "/local/scratch/mutational_signatures_" + cancer + "_" + region + "/Mutational_Signatures/" + cancer + "/" + region + "/6kb/", 
			"/local/scratch/mutational_signatures_" + cancer + "_" + region + "/Mutational_Profiles/" + cancer + "/" + region + "/SBS/" + cancer + "_" + region + "_6kb.SBS96.all", 
