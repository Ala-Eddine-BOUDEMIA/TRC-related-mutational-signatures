...
cp -r /data/tmp/aboudemi/Data/ /local/scratch/blca_remain_signatures
...
cp -r /local/scratch/blca_remain_profiles/Mutational_Signatures/BLCA/Remain /data/tmp/aboudemi/Mutational_Signatures/BLCA/Remain
