...
cp -r /data/tmp/aboudemi/Data/ /local/scratch/brca_tss_profiles
...
cp -r /local/scratch/brca_tss_profiles/Data/BRCA/TSS/6kb/output/* /data/tmp/aboudemi/Mutational_Profiles/BRCA/TSS/
