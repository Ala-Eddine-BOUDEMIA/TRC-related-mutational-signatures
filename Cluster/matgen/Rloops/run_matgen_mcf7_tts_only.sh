...
cp /data/tmp/aboudemi/Data/MCF7/TTS/E2-2h/only_tts_mutations.maf /local/scratch/mutational_profiles_mcf7_tts_E2-2h/Data/MCF7/TTS/E2-2h/
...
cp -r /local/scratch/mutational_profiles_mcf7_tts_E2-2h/Data/MCF7/TTS/E2-2h/output/* /data/tmp/aboudemi/Mutational_Profiles/MCF7/TTS/E2-2h/
